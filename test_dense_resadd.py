...
def main():
    ...
    inp = np.loadtxt("./iron_kernels/test_data/dense_resadd_input.txt", dtype=np.int8)
    ref = np.loadtxt("./iron_kernels/test_data/dense_resadd_out_ref.txt", dtype=np.int8).flatten()
