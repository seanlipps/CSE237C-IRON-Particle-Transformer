...
def main():
    ...
    inp = np.loadtxt(r"/notebooks/CSE237C-IRON-Particle-Transformer/temp_q1_head0_in0.txt", dtype=np.int8)
    ref = np.loadtxt(r"/notebooks/CSE237C-IRON-Particle-Transformer/data/a1_head0_q_golden.txt", dtype=np.int8).flatten()
